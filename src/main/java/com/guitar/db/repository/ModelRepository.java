...
public class ModelRepository {
	...
	public List<Model> getModelsByType(String modelType) {
		...
		/*
		The Spring Data JPA way of doing a NamedQuery is below; call the ModelJpaRepository method, passing in the name which then uses
		the @NamedQuery in the Model.java entity.
		*/
		return modelJpaRepository.findAllModelsByType(modelType);


		/* This would be the way to do a NamedQuery in regular JPA, i.e. directly within this method:
